...
function Grid1() {
    return (
        <section
            className="flex flex-wrap content-between py-8 px-6 col-span-8 lg:col-span-3 bg-grid1 bg-right-bottom bg-no-repeat bg-contain font-semibold [font-size:3.5rem] leading-[1.2]">
